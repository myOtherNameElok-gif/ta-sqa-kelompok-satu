...
String filepath = 'C:\\Users\\cici\\Documents\\DATA_STATUS_USER(5mb).xlsx'

WebUI.uploadFile(findTestObject('Object Repository/Page_HADIR/import file'), filepath)

WebUI.click(findTestObject('Object Repository/Page_HADIR/button__MuiButtonBase-root MuiButton-root M_312ba1'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_HADIR/div_Admin Hadir_gagaluppload'), 120)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_HADIR/div_Admin Hadir_gagaluppload'), 0)
