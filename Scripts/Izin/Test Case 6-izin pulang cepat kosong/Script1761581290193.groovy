...
WebUI.click(findTestObject('Object Repository/Page_mobileHADIR/button_Terlambat_MuiButtonBase-root MuiTab-_31d0e4'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_mobileHADIR/p__mui-4-helper-text'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_mobileHADIR/p__mui-5-helper-text'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_mobileHADIR/p__notes-helper-text'), 0)
