...
String filepath = 'C:\\Users\\cici\\Documents\\DATA_STATUS_USER(pdf).pdf'

WebUI.uploadFile(findTestObject('Object Repository/Page_HADIR/import file'), filepath)

WebUI.click(findTestObject('Page_HADIR/button__MuiButtonBase-root MuiButton-root M_312ba1'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_HADIR/p__selfie-helper-text'), 0)
